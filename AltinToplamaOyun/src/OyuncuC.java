...
public class OyuncuC {
	...
	public OyuncuC(int x, int y, int alinanYol, int altin, int hedefMaliyet, int adimMaliyet) {
	...
	public void CHedefBelirle(int oyuncuX, int oyuncuY, List<Integer> altin, int alan[][]) {
