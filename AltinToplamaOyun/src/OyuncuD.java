...
public class OyuncuD {
	...
	public boolean devamEdebilirMi;
	public List<Integer> yol = new ArrayList<Integer>();
	public int adimMaliyet;
	public int hedefAltin;
	
	public OyuncuD(int x, int y, int alinanYol, int altin, int hedefMaliyet, int adimMaliyet) {
	...
	public void DHedefBelirle(int oyuncuX, int oyuncuY, List<Integer> altin, int alan[][]) {
		...
		for(int i = 0; i < altin.size(); i = i + 2) {
			...
			int yolaHarcananAltin = ((yol / 3) * 5) + hedefAltinMiktari;
	...
	public void setDevamEdebilirMi(boolean devam) {
		this.devamEdebilirMi = devam;
	}
	...
	public boolean getDevamEdebilirMi() {
		return this.devamEdebilirMi;
	}
